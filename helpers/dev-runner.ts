...
const mainConfig = require('./configs/webpack.main.config')
const preloadConfig = require('./configs/webpack.preload.config')
const rendererConfig = require('./configs/webpack.renderer.config')
